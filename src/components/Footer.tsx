    ...
    return (
        <section>
            <div className=" max-w-screen-md">
                ...
                <form action="https://getform.io/f/7axPqzay" method="POST" className="space-y-8">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="company" name="company" className="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Company" required />
                    </div>
                    <div className="sm:col-span-2">
                        {/* <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Your message</label> */}
                        <textarea id="message" name='message' rows={2} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Message"></textarea>
                    </div>
            ...
            <div className='flex flex-wrap lg:justify-around px-4 py-8'>
                <div>
                    ...
                    <div className="flex -m-2 my-4">
                        <a href="https://www.linkedin.com/company/ethsoil/" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" target='_blank' aria-label="Linkedin">
                        ...
                        <a href="mailto:riteshsingh@ethsoil.com" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Facebook">
