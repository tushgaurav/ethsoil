            ...
            <div className='flex flex-wrap lg:justify-around px-4 py-8'>
                <div>
                    ...
                    <div className="flex -m-2 my-4">
                        <a href="https://www.linkedin.com/company/ethsoil/" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Linkedin">
